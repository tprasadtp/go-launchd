...
DATA	·libc_launch_msg_trampoline_addr(SB)/8, $libc_flaunch_msg_trampoline<>(SB)
...
DATA	·libc_launch_data_get_errno_trampoline_addr(SB)/8, $libc_flaunch_data_get_errno_trampoline<>(SB)
...
DATA	·libc_launch_data_alloc_trampoline_addr(SB)/8, $libc_flaunch_data_alloc_trampoline<>(SB)
...
DATA	·libc_launch_data_free_trampoline_addr(SB)/8, $libc_flaunch_data_free_trampoline<>(SB)
...
DATA	·libc_launch_data_new_string_trampoline_addr(SB)/8, $libc_flaunch_data_new_string_trampoline<>(SB)
...
DATA	·libc_launch_data_get_string_trampoline_addr(SB)/8, $libc_flaunch_data_get_string_trampoline<>(SB)
...
DATA	·libc_launch_data_get_type_trampoline_addr(SB)/8, $libc_flaunch_data_get_type_trampoline<>(SB)
...
DATA	·libc_launch_data_dict_lookup_trampoline_addr(SB)/8, $libc_flaunch_data_dict_lookup_trampoline<>(SB)
...
DATA	·libc_launch_data_get_fd_trampoline_addr(SB)/8, $libc_flaunch_data_get_fd_trampoline<>(SB)
